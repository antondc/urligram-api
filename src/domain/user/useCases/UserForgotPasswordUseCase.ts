...
export class UserForgotPasswordUseCase implements IUserForgotPasswordUseCase {
  ...
  public async execute(userLogin: IUserForgotPasswordRequest): Promise<IUserForgotPasswordResponse> {
    ...
    const emailOptions = {
      ...
      html: `<html> <head> <meta charset="utf-8"/> <meta name="color-scheme" content="only"/> <meta name="x-apple-disable-message-reformatting"/> <title>Woprs - social bookmarking</title> <style>body{margin-right: 20px; margin-left: 20px;}.body{position: relative; font-size: 1.3em; margin-top: 30px; margin-right: auto; margin-bottom: 50px; margin-left: auto; width: 100%; max-width: 600px; padding: 20px 40px 40px; background-color: #fffffe; line-height: 27px; border: 8px solid #3182e1; font-family: sans-serif; font-weight: bold; color: #0d2540;}.header{font-weight: bold;}.footer{padding: 0px; margin-top: 50px;}.centered{text-align: center; width: 100%; margin: 30px auto 40px;}.button{text-align: center; padding: 10px 50px; margin: 0 auto; background: #3182e1; color: #fffffe; border: 4px solid #3182e1; text-decoration: none; text-transform: uppercase; font-size: 18px;}.link{text-decoration: none; color: #3182e1;}.link:visited{text-decoration: underline; color: #3182e1;}.link:hover{text-decoration: underline; color: #6da4e4; text-decoration: none; transition: color 0.15s ease;}.disabledLink{text-decoration: none; color: #0d2540; pointer-events: none;}.hr{border: 2px solid #3182e1; margin-bottom: 20px;}</style> </head> <body> <div class="body"> <p>Hi ${user?.name}!</p><div class="main"> <p> We received a request to reset the password related to the email <a class="disabledLink" href="mailto:${user?.email}"> ${user?.email}</a > . No changes were made to your account yet. </p><p>You can reset your password by clicking the link below:</p><p class="centered"> <a class="button" href="${ENDPOINT_CLIENTS[0]}/reset-password?name=${user?.name}&token=${token}" > Reset my password</a > </p><p> If you did not request this change please contact us by replying to this email. </p><p> You can find more answers in the <a class="link" href="${ENDPOINT_CLIENTS[0]}/reset-password?name=${user?.name}&token=${token}" > documentation</a > page, and you can contact us for any question you may have. </p></div><div class="footer"> <hr class="hr"/> The Woprs team<br/> <a class="link" href="mailto:hello@woprs.com">hello@woprs.com</a><br/> </div></div></body></html>`,
    };
