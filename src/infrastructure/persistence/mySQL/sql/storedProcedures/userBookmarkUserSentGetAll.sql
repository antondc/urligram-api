...
BEGIN
  ...
  SELECT DISTINCT
    ...
    `link`.`favicon`,
    userBookmarkUser.user_id2 as receiverId,
    $SESSION_ID as senderId
  FROM bookmark
...
/* DELIMITER ; */
/* CALL user_bookmark_user_sent_get_all('b95274c9-3d26-4ce3-98b2-77dce5bd7aae', 'b95274c9-3d26-4ce3-98b2-77dce5bd7aae', NULL, NULL, NULL, NULL); */