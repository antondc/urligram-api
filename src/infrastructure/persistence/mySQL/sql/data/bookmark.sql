...
INSERT INTO `bookmark` (
  ...
  2, 1, "My link 2", true, true, false, DEFAULT, DEFAULT, '75442486-0878-440c-9db1-a7006c25a39f', 6
);

INSERT INTO `bookmark` (
  `id`, `order`, `title`, `isPrivate`, `saved`, `vote`, `createdAt`, `updatedAt`, `user_id`, `link_id`
) VALUES (
  3, 2, "My link 3", false, true, NULL, DEFAULT, DEFAULT, '11bf5b37-e0b8-42e0-8dcf-dc8c4aefc000', 7
);
