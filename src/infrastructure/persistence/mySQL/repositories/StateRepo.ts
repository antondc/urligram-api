...
export class StateRepo {
  ...
  private userDeleteMeProcedure: string;
  ...
  constructor() {
    ...
    this.userDeleteMeProcedure = fs.readFileSync(path.resolve(__dirname, '../sql/storedProcedures/userDeleteMe.sql')).toString();
  ...
  public async resetContent() {
    ...
    try {
      ...
      const createUserDeleteMeProcedure = await mySQL.query(this.userDeleteMeProcedure);
